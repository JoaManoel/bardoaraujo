<!DOCTYPE html>
<html class="wide wow-animation" lang="ptbr">
  <head>
    <title>Araujo-Bar e Lanchonete</title>
    ...
    <meta charset="utf-8">
    <meta name="description" content="Lanches Guaratinguetá, Bebidas em Guaratingueta, Bar do Araujo Jardim do Vale, Jardim do Vale">
            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a class="brand" href="inicio.php"><img src="images/logo-default-196x47.png" alt="" width="196" height="47"/></a></div>
                </div>
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="contato.php">Contatos</a>
                      </li>
                    </ul>
                  </div>
                ...
                <div class="rd-navbar-project rd-navbar-modern-project">
                  ...
                  <div class="rd-navbar-project-content rd-navbar-modern-project-content">
                    <div>
                      <p>Siga-nos em nossas redes sociais e fique por dentro das promoções, particpe para ganhar prêmios e grandes descontos!!.</p>
                      
                      <ul class="rd-navbar-modern-contacts">
                        <li>
                          <div class="unit unit-spacing-sm">
                            <div class="unit-left"><span class="icon fa-brands fa-whatsapp"></span></div>
                            <div class="unit-body"><a target="_blank" title="Ir para o whatsapp" class="link-phone" href="http://api.whatsapp.com/send?1=pt_BR&phone=5512991255734">+55 12-99125-5734</a></div>
                          </div>
                        </li>
                        <li>
                          <div class="unit unit-spacing-sm">
